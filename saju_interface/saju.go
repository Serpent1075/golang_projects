...
func (sa *SajuAnalyzer) Evaluate_GoonbHab(host *Person, opponent *Person) (float64, float64, string, string) {
	...
	final_host_grade = (0.5*host_grade[0] + 2.5*host_grade[1] + 4*host_grade[2] + 3*host_grade[3]) / 10
	final_opponent_grade = (0.5*opponent_grade[0] + 2.5*opponent_grade[1] + 4*opponent_grade[2] + 3*opponent_grade[3]) / 10
